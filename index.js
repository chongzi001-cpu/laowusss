...
const SUB_PATH = process.env.SUB_PATH || 'xiaomao';       // 订阅路径
const PORT = process.env.SERVER_PORT || process.env.PORT || 3000;        // http服务订阅端口
const UUID = process.env.UUID || 'ba9b7008-3121-47fa-84dd-4b1e68aad7bc'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || '';        // 哪吒v1填写形式: nz.abc.com:8008  哪吒v0填写形式：nz.abc.com
const NEZHA_PORT = process.env.NEZHA_PORT || '';            // 使用哪吒v1请留空，哪吒v0需填写
const NEZHA_KEY = process.env.NEZHA_KEY || '';              // 哪吒v1的NZ_CLIENT_SECRET或哪吒v0的agent密钥
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'suidaomao.3km.de5.net';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiNWI1Y2UxZWNiOGU3MWMyNjNjNDVhM2NiZWE1ZTUwZGUiLCJ0IjoiYjlhMzFkNTUtYjgyYS00ZDE5LWJjNzAtNjkyMGIyNjJkZjgyIiwicyI6Ik0ySTROR0ZoWmpRdFpXTmpOaTAwTVROaUxUaGhZbUV0WTJKbU5XUTRPR0l5T0dWayJ9
...
const NAME = process.env.NAME || 'xiaomao';                        // 节点名称
